 ...
 */
@SpringBootTest(classes = AutenticacaoIntegrationTest.Config.class)
...
class AutenticacaoIntegrationTest {
    ...
    static class Config {
        ...
        /**
         * As entidades de segurança usam {@code @TenantId}; sem um resolver o Hibernate não
         * consegue preencher o discriminador. O módulo archbase-multitenancy não é dependência
         * daqui, então o teste fornece o mínimo.
         */
        @Bean
