...
public abstract class CommonArchbaseService<T, ID extends Serializable, N extends Number & Comparable<N>> extends SimpleArchbaseQueryService<T, ID, N> {
    ...
    protected CommonArchbaseService(Repository<T, ID, N> repository) {
        super(repository);
    }
