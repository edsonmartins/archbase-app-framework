...
public abstract class SimpleArchbaseCommandService<T, ID extends Serializable, N extends Number & Comparable<N>> {
    ...
    @Autowired
    protected SimpleArchbaseCommandService(Repository<T, ID, N> repository) {
