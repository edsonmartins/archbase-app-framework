...
public abstract class SimpleArchbaseCommandRestController<T extends AggregateRoot<T, ID>, ID extends Serializable & Identifier, N extends Number & Comparable<N>> {
