 ...
 */
public class TestArchbasePluginDescriptor extends DefaultArchbasePluginDescriptor {

    @Override
    public DefaultArchbasePluginDescriptor setPluginId(String pluginId) {
    ...
    @Override
    public DefaultArchbasePluginDescriptor setPluginVersion(String version) {
