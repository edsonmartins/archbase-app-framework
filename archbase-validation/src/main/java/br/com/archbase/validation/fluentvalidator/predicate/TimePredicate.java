...
public final class TimePredicate {
  ...
  public static Predicate<String> timeEqualTo(final String timeString, final String pattern) {
    return PredicateBuilder.<String>from(not(nullValue()))
        .and(timeEqualTo -> not(StringPredicate.stringEmptyOrNull()).test(timeString))
        .and(timeEqualTo -> not(StringPredicate.stringEmptyOrNull()).test(pattern)).and(timeEqualTo -> {
          try {
  ...
  public static Predicate<String> timeGreaterThan(final String timeString, final String pattern) {
    return PredicateBuilder.<String>from(not(nullValue()))
        .and(timeGreaterThan -> not(StringPredicate.stringEmptyOrNull()).test(timeString))
        .and(timeGreaterThan -> not(StringPredicate.stringEmptyOrNull()).test(pattern)).and(timeGreaterThan -> {
          try {
            final DateTimeFormatter timeFormat = DateTimeFormatter.ofPattern(pattern);
  ...
  public static Predicate<String> timeLessThan(final String timeString, final String pattern) {
    return PredicateBuilder.<String>from(not(nullValue()))
        .and(timeLessThan -> not(StringPredicate.stringEmptyOrNull()).test(timeString))
        .and(timeLessThan -> not(StringPredicate.stringEmptyOrNull()).test(pattern)).and(timeLessThan -> {
          try {
            final DateTimeFormatter timeFormat = DateTimeFormatter.ofPattern(pattern);
