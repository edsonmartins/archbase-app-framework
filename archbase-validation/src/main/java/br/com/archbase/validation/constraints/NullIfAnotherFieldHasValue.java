...
import br.com.archbase.validation.validators.NullIfAnotherFieldHasValueValidator;
...
public @interface NullIfAnotherFieldHasValue {
    ...
    String message() default "{br.com.archbase.bean.validation.constraints.NullIfAnotherFieldHasValue.message}";
