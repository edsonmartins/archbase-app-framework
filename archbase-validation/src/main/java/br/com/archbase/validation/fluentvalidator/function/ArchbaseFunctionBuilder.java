package br.com.archbase.validation.fluentvalidator.function;

import java.util.Objects;
import java.util.function.Function;

public final class ArchbaseFunctionBuilder<I, O> implements Function<I, O> {
   ...
   * @param function
   */
  private ArchbaseFunctionBuilder(final Function<I, O> function) {
    this.function = function;
  }

  public static <I, O> Function<I, O> of(final Function<I, O> function) {
    return new ArchbaseFunctionBuilder<>(function);
  }
