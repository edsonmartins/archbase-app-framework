...
import static br.com.archbase.validation.fluentvalidator.predicate.StringPredicate.stringEmptyOrNull;
...
public final class DateTimePredicate {
  ...
  public static Predicate<String> dateTimeEqualTo(final String dateString, final String pattern) {
    return PredicateBuilder.<String>from(not(nullValue()))
        .and(dateTimeEqualTo -> not(StringPredicate.stringEmptyOrNull()).test(dateString))
        .and(dateTimeEqualTo -> not(StringPredicate.stringEmptyOrNull()).test(pattern)).and(dateTimeEqualTo -> {
          try {
  ...
  public static Predicate<String> dateTimeGreaterThan(final String dateString, final String pattern) {
    return PredicateBuilder.<String>from(not(nullValue()))
        .and(dateTimeGreaterThan -> not(StringPredicate.stringEmptyOrNull()).test(dateString))
        .and(dateTimeGreaterThan -> not(StringPredicate.stringEmptyOrNull()).test(pattern))
  ...
  public static Predicate<String> dateTimeLessThan(final String dateString, final String pattern) {
    return PredicateBuilder.<String>from(not(nullValue()))
        .and(dateTimeLessThan -> not(StringPredicate.stringEmptyOrNull()).test(dateString))
        .and(dateTimeLessThan -> not(StringPredicate.stringEmptyOrNull()).test(pattern)).and(dateTimeLessThan -> {
          try {
            final DateTimeFormatter dateFormat = DateTimeFormatter.ofPattern(pattern);
