...
public final class LocalDateTimePredicate {
  ...
  public static <T extends LocalDateTime> Predicate<T> localDateTimeAfterToday() {
    return PredicateBuilder.<T>from(not(nullValue()))
        .and(localDateTime -> LocalDatePredicate.localDateAfterToday().test(localDateTime.toLocalDate()));
  }
  ...
  public static <T extends LocalDateTime> Predicate<T> localDateTimeAfterOrEqualToday() {
    return PredicateBuilder.<T>from(not(nullValue()))
        .and(localDateTime -> LocalDatePredicate.localDateAfterOrEqualToday().test(localDateTime.toLocalDate()));
  }
  ...
  public static <T extends LocalDateTime> Predicate<T> localDateTimeBeforeToday() {
    return PredicateBuilder.<T>from(not(nullValue()))
        .and(localDateTime -> LocalDatePredicate.localDateBeforeToday().test(localDateTime.toLocalDate()));
  }
  ...
  public static <T extends LocalDateTime> Predicate<T> localDateTimeBeforeOrEqualToday() {
    return PredicateBuilder.<T>from(not(nullValue()))
        .and(localDateTime -> LocalDatePredicate.localDateBeforeOrEqualToday().test(localDateTime.toLocalDate()));
  }
  ...
  public static <T extends LocalDateTime> Predicate<T> localDateTimeIsToday(){
    return PredicateBuilder.<T>from(not(nullValue()))
        .and(localDateTime -> LocalDatePredicate.localDateIsToday().test(localDateTime.toLocalDate()));
  }
