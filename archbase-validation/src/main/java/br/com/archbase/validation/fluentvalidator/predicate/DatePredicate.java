...
public final class DatePredicate {
  ...
  public static Predicate<String> dateEqualTo(final String dateString, final String pattern) {
    return PredicateBuilder.<String>from(not(nullValue()))
        .and(dateEqualTo -> not(StringPredicate.stringEmptyOrNull()).test(dateString))
        .and(dateEqualTo -> not(StringPredicate.stringEmptyOrNull()).test(pattern)).and(dateEqualTo -> {
          try {
  ...
  public static Predicate<String> dateGreaterThan(final String dateString, final String pattern) {
    return PredicateBuilder.<String>from(not(nullValue()))
        .and(dateGreaterThan -> not(StringPredicate.stringEmptyOrNull()).test(dateString))
        .and(dateGreaterThan -> not(StringPredicate.stringEmptyOrNull()).test(pattern)).and(dateGreaterThan -> {
          try {
            final DateTimeFormatter dateFormat = DateTimeFormatter.ofPattern(pattern);
  ...
  public static Predicate<String> dateLessThan(final String dateString, final String pattern) {
    return PredicateBuilder.<String>from(not(nullValue()))
        .and(dateLessThan -> not(StringPredicate.stringEmptyOrNull()).test(dateString))
        .and(dateLessThan -> not(StringPredicate.stringEmptyOrNull()).test(pattern)).and(dateLessThan -> {
          try {
            final DateTimeFormatter dateFormat = DateTimeFormatter.ofPattern(pattern);
