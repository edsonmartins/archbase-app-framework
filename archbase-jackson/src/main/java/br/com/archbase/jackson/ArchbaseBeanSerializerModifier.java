...
/**
 * Modificador de serializer para detectar e otimizar serialização de Value Objects.
 * <p>
 * Value Objects com um único campo são serializados como o valor direto,
 * sem wrapper JSON.
 * </p>
 */
public class ArchbaseBeanSerializerModifier extends BeanSerializerModifier {
    ...
    public JsonSerializer<?> modifySerializer(
        ...
        if (isSingleFieldValueObject(beanClass)) {
            ...
            return new SingleValueObjectSerializer(javaType);
        }
